...
@implementation PrirceTableViewController
...
-(void)payAction{
    switch (self.tableView.indexPathForSelectedRow.row) {
        case 0:{
            ...
            [GBAlipayManager alipayWithProductName:_Hotel.hotel_name amount:[NSString stringWithFormat:@"%ld元",(long)_Hotel.Price] tradeNO:tradeNo notifyURL:nil productDescription:[NSString stringWithFormat:@"%@活动报名费",_Hotel.hotel_name] itBPay:@"30"];
        }
            break;
        case 1:{
